...
#SBATCH --partition=patterli_p #gpu_p #patterli_p #patterli_p # Partition (queue) name, i.e., gpu_p
#SBATCH --gres=gpu:V100:1 # Requests one GPU device; --gres=gpu:P100:1, --gres=gpu:K40:1
