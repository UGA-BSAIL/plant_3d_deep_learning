...
fnames = ["denorm_0.txt","denorm_1.txt","denorm_2.txt","denorm_3.txt","denorm_4.txt","denorm_10.txt","denorm_6.txt","denorm_7.txt","denorm_8.txt"];%,"denorm_9.txt","denorm_10.txt"];
% fnames = ["denorm_1.txt"];
% %     
...
pcshow(branch_pts, branch_clr, 'MarkerSize',500); hold off;
grid off;
set(gcf,'color','w');
set(gca,'color','w');
axis off;
