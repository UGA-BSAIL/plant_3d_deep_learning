#!/bin/bash
#SBATCH --job-name=pointnetplantnetp100_aug_tl_nd # Job name
...
cd /scratch/fs47816/workdir/sample_scripts/Pointnet2_plantnet_p100_aug_tl_1000ep_nd/Pointnet_Pointnet2_pytorch
...
python train_partseg.py --model pointnet2_part_seg_msg --batch_size 1 --epoch 2250 --log_dir pointnet2_part_seg_msg --npoint 100000
