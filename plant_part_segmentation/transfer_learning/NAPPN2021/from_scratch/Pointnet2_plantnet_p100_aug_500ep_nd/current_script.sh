#!/bin/bash
#SBATCH --job-name=pointnetplantnetp100_aug_nd # Job name
...
python train_partseg.py --model pointnet2_part_seg_msg --batch_size 1 --epoch 500 --log_dir pointnet2_part_seg_msg --npoint 100000
